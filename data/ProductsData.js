		...
		setStudentData: function (studentInfo) {
			...
			for (let i = 0; i < studentInfo.length; ++i) {
				...
				if (
					...
					!student[0] ||
					typeof student[1] !== "string" ||
					!student[1] ||
					typeof student[2] !== "string" ||
					!student[2] ||
				...
				studentData.push({
					...
					linkedin:
						student[1] === "#"
							? "#"
							: `https://www.linkedin.com/in/${student[1]}/`,
					position: student[2],
				});
			}
...
const ProductData = [
	...
	new ProductBuilder()
		...
		.setOverview(
			"Hangover is a social gaming app inspired by Cards Against Humanity and Kahoot. " +
	...
	new ProductBuilder()
		...
		.setOverview(
			"How many times did you buy something, use it once or twice then let it " +
	...
	new ProductBuilder()
		...
		.setOverview(
			"We all want to help charitable causes, but act of doing so can be " +
	...
	new ProductBuilder()
		...
		.setOverview(
			"Take a look at 'Things do to in city x' on Google and what to do you see? " +
	...
	new ProductBuilder()
		...
		.setOverview(
			"Everyone loves thinking about and starting side projects, but we " +
	...
	new ProductBuilder()
		...
		.setLogoDimensions({ width: 200, height: 100 })
		.setOverview(
			"Buying gifts for friends is too much of a chore - you never " +
	...
	new ProductBuilder()
		...
		.setOverview(
			"As securing an internship is becoming increasingly " +
